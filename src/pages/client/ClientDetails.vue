    ...
    <v-col cols="12" sm="6" md="7" lg="8">
      ...
      <v-card v-if="!loading" :loading="loading">
        ...
        <v-card-text v-if="client.prescriptions && client.prescriptions.length > 0" class="d-flex flex-column ga-3">
          <div v-for="prescription in client.prescriptions" variant="tonal" density="comfortable" color="disabled" class="px-3 py-2 d-flex ga-3 justify-space-between align-center text-none bg-surface" :key="prescription.id">
